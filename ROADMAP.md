...
**Порядок приоритета:** сначала закрыть функциональные блоки 13–16 и зафиксировать ручные пункты блока 17; только после этого возвращаться к финализации автодеплоя и проводить полный deployment-тест.
