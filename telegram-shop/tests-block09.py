...
checks=[('/api/catalog',None),('/api/catalog?price_min=0&price_max=999999',None),('/api/catalog?sort=price_asc',None),('/api/catalog?q=%25%3C%3E',None),('/api/catalog?condition=used&has_photo=true&negotiable=true&seller=no-such-seller',None),('/api/catalog?sort=price_desc',None)]
