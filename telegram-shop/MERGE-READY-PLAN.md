...
### Android
- [ ] APK `telegram-shop/apk/Sklad-1.1.0-release.apk` устанавливается на реальном устройстве
- [ ] AAB `telegram-shop/aab/Sklad-1.1.0-release.aab` готов для RuStore
...
- [ ] `/api/releases/android` возвращает актуальные данные по `1.1.0`
...
3. Проверить APK `1.1.0` на телефоне
...
- APK `1.1.0` проверен на реальном Android-устройстве
