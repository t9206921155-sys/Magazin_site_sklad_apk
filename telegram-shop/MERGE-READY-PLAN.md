...
### Android
- [ ] APK `telegram-shop/apk/Sklad-1.0.5-release.apk` устанавливается на реальном устройстве
- [ ] AAB `telegram-shop/aab/Sklad-1.0.5-release.aab` готов для RuStore
...
- [ ] `/api/releases/android` возвращает актуальные данные по `1.0.5`
...
- APK `1.0.5` проверен на реальном Android-устройстве
