...
- `apk/Sklad-1.1.0-release.apk`
- `aab/Sklad-1.1.0-release.aab`

Проверка:

```bash
sha256sum apk/Sklad-1.1.0-release.apk aab/Sklad-1.1.0-release.aab
```
...
1. установка `Sklad-1.1.0-release.apk`
...
Проверить ещё раз:
- загружается именно `aab/Sklad-1.1.0-release.aab`
...
- в приложении установлена версия `1.1.0`
...
2. пройти smoke-check сайта, Android-лендинга и APK `1.1.0`
...
- APK `1.1.0` устанавливается и подключается к складу по `sklad://connect?...`
