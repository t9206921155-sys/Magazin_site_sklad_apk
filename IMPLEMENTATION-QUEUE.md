...
- [x] Backup/restore: `scripts/verify_restore.py` — восстановление во временную БД + сверка с живой (COUNT, опц. SHA256); тесты tests-block14 (32/32, в run-tests.sh/CI с 12.09.2026; фикс сверки: база берётся из MAGAZIN_DB). Восстановление на чистом VPS — блок 18.
